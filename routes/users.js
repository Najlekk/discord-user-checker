...
router.get('/:userId', function(req, res, next) {
  ...
  //resp_data['avatar_url'] = 'https://cdn.discordapp.com/avatars/' + resp_data['id'] + '/' + resp_data['avatar'];
  //res.send(resp_data);
  //resp_data['banner_url'] = 'https://cdn.discordapp.com/avatars/' + resp_data['id'] + '/' + resp_data['a_3eae3f9762fd9ace451dcfb2109306ac'];
  //res.send(resp_data)
});

router.get('/avatars/:userId/:userAvatar', function(req, res, next) {
  res.setHeader('content-type', 'application/json');
  var JSONObject = {
    general:
        {
